// AuditCore — asset VENDORÉ : composant « filtres de colonne » du socle Digit-AI
// (forge-organization, output/02-composants/composant-filtres-tableau, checklist G1-G6).
// Copie figée : le rapport d'audit est un livrable autonome, aucun chargement réseau.
// Ne pas éditer ici — remonter toute correction au composant amont, puis re-vendorer.
// Consommé par rapport-engine.mjs, qui l'inline dans le <script> du rapport ; le kit
// standalone (build-kit.mjs) l'inline à son tour, avant le moteur.
export const TABLE_FILTERS_JS = String.raw`
