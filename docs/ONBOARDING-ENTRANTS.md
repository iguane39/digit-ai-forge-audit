...
| Renommage cosmétique d'une dimension | `dimensions.relabel` | Optionnel (déf. : libellés core `D00`–`D17`) | Objet `{ D00..D17: libellé }` — renommage seul, jamais suppression | exemple : `D15` → « Data by Design » | Architecture / DSI |
